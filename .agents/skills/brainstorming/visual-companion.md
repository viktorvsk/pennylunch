...
The server must keep running across conversation turns. If your local Codex environment reaps detached processes, use `--foreground` and keep the shell session open.
